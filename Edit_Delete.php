...
<?php
	...
	// For showing individual users post to edit or delte who is logged in only
	...
	while($record = mysql_fetch_array($myData)){
		...
		//checking by onclick either user sure or not to delete the post
		echo "<td>"."<input type='submit' name='delete' value='delete'onclick='return check()'>"."</td>";
		echo "</tr>";
