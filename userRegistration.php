<?php
	...
	$_POST['country'],$_POST['gender'],$_POST['dob'])){
		...
		elseif($_POST['email']==""){
			...
			if($uLength<6){
				echo "Username should be at least six character";
			}
			elseif($pLength<6){
				echo "Password should be at least six character";
			}
				elseif(!preg_match("/^[a-zA-Z ]*$/",$userName)) {
					echo "For username Only letters and white space allowed"."<br>";
					
				}
				elseif(!preg_match("/^[a-zA-Z ]*$/",$firstName)){
					echo "For First name Only letters and white space allowed"."<br>";
				}
				elseif(!preg_match("/^[a-zA-Z ]*$/",$lastName)){
					echo "For last name Only letters and white space allowed"."<br>";
				}
				...
				$db = new Blog;
				$db->insertElement($userName,$password,$firstName,$lastName,$country,$gender,$dateOfBirth);
			}
		}
				...
				<div class="row">
					...
					<form action="userRegistration.php" method="post">
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<input type="password" class="form-control" id="name" name='password' placeholder="Type your password" required>
							</div>
						</div>	
						<div class="form-group">
							<label for="name" class="col-md-2">E-mail*</label>
							<div class="col-md-12">
						...
						<div class="form-group">
							<label for="name" class="col-md-2">Country Name</label>
							<div class="col-md-12">
						...
						<div class="form-group">
							<label for="name" class="col-md-2">Date of Birth</label>
							<div class="col-md-12">
								<input type="text" class="form-control" id="name" name="dob" placeholder="dd-mm-yy" required>
							</div>
						</div>
						<div class="form-group">
							<label for="name" class="col-md-2"></label>
							<div class="col-md-12">
								<button type="submit" class="btn btn-lg btn-warning" value="submit">Submit</button>
							</div>
						</div>								
